...
urlpatterns = [
    ...
    path('export-data/status/', views.ExportDataStatusView.as_view(), name='export_data_status'),
    path('sessions/', views.DeviceSessionsListView.as_view(), name='device_sessions'),
    path('sessions/<int:session_id>/', views.RevokeSessionView.as_view(), name='revoke_session'),
