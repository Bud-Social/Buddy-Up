...
urlpatterns = [
    ...
    path('<str:gym_slug>/membership/checkout/', views.GymMembershipCheckoutView.as_view(), name='membership_checkout'),
    path('<str:gym_slug>/membership-exceptions/', views.GymMembershipExceptionsListView.as_view(), name='membership_exceptions'),
    path('<str:gym_slug>/membership-exceptions/<uuid:exception_id>/', views.GymMembershipExceptionDetailView.as_view(), name='membership_exception_detail'),
