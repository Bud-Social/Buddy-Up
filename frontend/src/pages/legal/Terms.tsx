...
export default function Terms() {
  return (
    <LegalPage
      ...
      subtitle="This is not medical, nutritional, legal or professional advice. BuddyUp Fit is a connection and accountability platform. Coaches, trainers and practitioners are independent providers, not employees of BuddyUp Fit."
    ...
    >
      <LegalSection title="1. Acceptance and Eligibility">
        ...
        <p className="mt-2">Users aged 16–17 may only use BuddyUp Fit with a verified parental co-owner (parent or guardian), who is bound by the same Terms and may be contacted by our Trust &amp; Safety team. Accounts found to belong to users under 16 are terminated.</p>
        <LegalNotice>
          You must provide accurate, current registration information. BuddyUp Fit may verify age, identity, and credentials, and may block or suspend accounts that rely on false information.
        </LegalNotice>
      </LegalSection>
      ...
      <LegalSection title="4. Health, Fitness & Nutrition Information">
        ...
        <p className="mt-2"><strong>No guarantees.</strong> Fitness and nutrition outcomes depend on individual factors and are never guaranteed. Meal plans and programmes provided on BuddyUp Fit are general wellness resources, not personalised medical nutrition therapy.</p>
      ...
      <LegalSection title="6. AI-Generated Content">
        <p>Every AI-generated output on BuddyUp Fit is labelled with its source and a limitation statement. You may not repost AI output as your own advice or present it as professional guidance. Automated moderation flags are reviewed by a human moderator before any removal action is taken.</p>
      </LegalSection>
      ...
      <LegalSection title="9. Marketplace Purchases">
        <p>Marketplace listings are governed by the seller's verification tier and their published cancellation/refund policy. BuddyUp Fit is the platform of record and is not the seller of record except for first-party items. Digital products are refundable within 7 days if not more than 25% consumed.</p>
      </LegalSection>
      ...
      <LegalSection title="11. Content Ownership &amp; Licence">
        <p>You retain ownership of content you create. You grant BuddyUp Fit a limited, non-exclusive, royalty-free licence to host, display, distribute, and process that content to operate the service (including ranking, search, and replay where applicable). The licence ends when you delete the content or close your account, subject to legal retention obligations.</p>
      </LegalSection>

      <LegalSection title="12. Suspension &amp; Termination">
        <p>BuddyUp Fit may suspend or terminate accounts that breach these Terms, the Community Guidelines, or applicable law, after a proportionate warning except in cases of imminent harm. You may close your account at any time; closure triggers a 30-day recoverable soft-delete followed by permanent deletion.</p>
      </LegalSection>

      <LegalSection title="13. Disclaimer of Warranties">
        <p>The service is provided "as is" and "as available". BuddyUp Fit does not warrant that fitness outcomes will be achieved and is not responsible for the actions, advice, or conduct of independent coaches, trainers, or practitioners. Users engage these professionals at their own risk.</p>
      </LegalSection>

      <LegalSection title="14. Limitation of Liability">
        <p>To the maximum extent permitted by law, BuddyUp Fit's aggregate liability for any claim is limited to the fees paid by you to BuddyUp Fit in the 12 months preceding the event giving rise to the claim. BuddyUp Fit is not liable for indirect, incidental, special, or consequential damages.</p>
      </LegalSection>

      <LegalSection title="15. Disputes">
        <p>Disputes are resolved through BuddyUp Fit's three-level procedure: (1) Buddy/gym-mediated, (2) Bud Concierge mediation for disputes up to KSh 20,000, and (3) a formal Dispute Panel for larger disputes and fraud/harm allegations. Unresolved disputes are subject to the exclusive jurisdiction of the Kenyan courts and governed by the laws of the Republic of Kenya.</p>
      </LegalSection>

      <LegalSection title="16. Changes to the Service or Terms">
        <p>BuddyUp Fit may add, modify, or remove features with reasonable notice. Material changes affecting your rights (including these Terms and the Privacy Policy) will be communicated by email and in-app at least 30 days before they take effect. Continued use after the effective date constitutes acceptance.</p>
      </LegalSection>

      <LegalSection title="17. Contact">
        <p>BuddyUp Fit Ltd., Nairobi, Kenya. For questions about these Terms, contact <strong>legal@buddyup.com</strong>. For safety concerns, contact <strong>report@buddyup.co.ke</strong>.</p>
      </LegalSection>
    </LegalPage>
  );
}
