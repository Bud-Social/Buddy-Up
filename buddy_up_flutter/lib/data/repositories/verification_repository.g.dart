...
class _VerificationRepository implements VerificationRepository {
  _VerificationRepository(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<dynamic> getSubmissions() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<dynamic> createSubmission(Map<String, dynamic> data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
