...
@useResult
$Res call({
 String id, AuthorData authorData, String postType, String body, bool isAnonymous, List<String> mediaUrls, List<String> tags, Map<String, dynamic>? workoutLogData, Map<String, dynamic>? mealData, Map<String, dynamic>? progressData, String locationLabel, int viewCount, Map<String, int> reactionCounts, String? userReaction, int commentCount, int repostCount, bool isRepost, String? originalPostId, String quoteBody, bool isSaved, bool isPinned, String visibility, String moderationStatus, String? gymTagId, String? gymTagName, Poll? poll, OriginalPostData? originalPostData, String createdAt, String? updatedAt
});
...
as String,gymTagId: freezed == gymTagId ? _self.gymTagId : gymTagId // ignore: cast_nullable_to_non_nullable
