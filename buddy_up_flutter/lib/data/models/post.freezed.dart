...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CaptionSegment&&(identical(other.startMs, startMs) || other.startMs == startMs)&&(identical(other.endMs, endMs) || other.endMs == endMs)&&(identical(other.text, text) || other.text == text));
}
...
@override
String toString() {
  return 'CaptionSegment(startMs: $startMs, endMs: $endMs, text: $text)';
}
...
class _CaptionSegment implements CaptionSegment {
  const _CaptionSegment({this.startMs = 0, this.endMs = 0, this.text = ''});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CaptionSegment&&(identical(other.startMs, startMs) || other.startMs == startMs)&&(identical(other.endMs, endMs) || other.endMs == endMs)&&(identical(other.text, text) || other.text == text));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ReposterDataCopyWith<ReposterData> get copyWith => _$ReposterDataCopyWithImpl<ReposterData>(this as ReposterData, _$identity);

  /// Serializes this ReposterData to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReposterData&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl));
}
...
@override
String toString() {
  return 'ReposterData(userId: $userId, displayName: $displayName, avatarUrl: $avatarUrl)';
}
...
/// @nodoc
abstract mixin class $ReposterDataCopyWith<$Res>  {
...
/// @nodoc
class _$ReposterDataCopyWithImpl<$Res>
    implements $ReposterDataCopyWith<$Res> {
  _$ReposterDataCopyWithImpl(this._self, this._then);

  final ReposterData _self;
  final $Res Function(ReposterData) _then;

/// Create a copy of ReposterData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = freezed,Object? displayName = null,Object? avatarUrl = null,}) {
  return _then(_self.copyWith(
userId: freezed == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as String?,displayName: null == displayName ? _self.displayName : displayName // ignore: cast_nullable_to_non_nullable
as String,avatarUrl: null == avatarUrl ? _self.avatarUrl : avatarUrl // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [ReposterData].
extension ReposterDataPatterns on ReposterData {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ReposterData value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ReposterData value)  $default,){
final _that = this;
switch (_that) {
case _ReposterData():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ReposterData value)?  $default,){
final _that = this;
switch (_that) {
case _ReposterData() when $default != null:
return $default(_that);case _:
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$ReposterDataCopyWith<_ReposterData> get copyWith => __$ReposterDataCopyWithImpl<_ReposterData>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ReposterDataToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReposterData&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl));
}
...
/// @nodoc
abstract mixin class _$ReposterDataCopyWith<$Res> implements $ReposterDataCopyWith<$Res> {
...
/// @nodoc
class __$ReposterDataCopyWithImpl<$Res>
    implements _$ReposterDataCopyWith<$Res> {
  __$ReposterDataCopyWithImpl(this._self, this._then);

  final _ReposterData _self;
  final $Res Function(_ReposterData) _then;

/// Create a copy of ReposterData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = freezed,Object? displayName = null,Object? avatarUrl = null,}) {
  return _then(_ReposterData(
userId: freezed == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as String?,displayName: null == displayName ? _self.displayName : displayName // ignore: cast_nullable_to_non_nullable
as String,avatarUrl: null == avatarUrl ? _self.avatarUrl : avatarUrl // ignore: cast_nullable_to_non_nullable
as String,
...
mixin _$OriginalPostData {
 ...
 String get id;@JsonKey(name: 'author_data') AuthorData get authorData; String get body;@JsonKey(name: 'media_urls') List<String> get mediaUrls; List<PostMedia> get media;@JsonKey(name: 'post_type') String get postType;@JsonKey(name: 'location_label') String? get locationLabel;@JsonKey(name: 'workout_log_data') Map<String, dynamic>? get workoutLogData; Poll? get poll;@JsonKey(name: 'comment_count') int get commentCount;@JsonKey(name: 'repost_count') int get repostCount;@JsonKey(name: 'view_count') int get viewCount;@JsonKey(name: 'share_count') int get shareCount;@JsonKey(name: 'save_count') int get saveCount;@JsonKey(name: 'reaction_counts') Map<String, int> get reactionCounts;@JsonKey(name: 'user_reaction') String? get userReaction;@JsonKey(name: 'gym_tag_name') String? get gymTagName;@JsonKey(name: 'created_at') String get createdAt;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OriginalPostData&&(identical(other.id, id) || other.id == id)&&(identical(other.authorData, authorData) || other.authorData == authorData)&&(identical(other.body, body) || other.body == body)&&const DeepCollectionEquality().equals(other.mediaUrls, mediaUrls)&&const DeepCollectionEquality().equals(other.media, media)&&(identical(other.postType, postType) || other.postType == postType)&&(identical(other.locationLabel, locationLabel) || other.locationLabel == locationLabel)&&const DeepCollectionEquality().equals(other.workoutLogData, workoutLogData)&&(identical(other.poll, poll) || other.poll == poll)&&(identical(other.commentCount, commentCount) || other.commentCount == commentCount)&&(identical(other.repostCount, repostCount) || other.repostCount == repostCount)&&(identical(other.viewCount, viewCount) || other.viewCount == viewCount)&&(identical(other.shareCount, shareCount) || other.shareCount == shareCount)&&(identical(other.saveCount, saveCount) || other.saveCount == saveCount)&&const DeepCollectionEquality().equals(other.reactionCounts, reactionCounts)&&(identical(other.userReaction, userReaction) || other.userReaction == userReaction)&&(identical(other.gymTagName, gymTagName) || other.gymTagName == gymTagName)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,authorData,body,const DeepCollectionEquality().hash(mediaUrls),const DeepCollectionEquality().hash(media),postType,locationLabel,const DeepCollectionEquality().hash(workoutLogData),poll,commentCount,repostCount,viewCount,shareCount,saveCount,const DeepCollectionEquality().hash(reactionCounts),userReaction,gymTagName,createdAt);

@override
String toString() {
  return 'OriginalPostData(id: $id, authorData: $authorData, body: $body, mediaUrls: $mediaUrls, media: $media, postType: $postType, locationLabel: $locationLabel, workoutLogData: $workoutLogData, poll: $poll, commentCount: $commentCount, repostCount: $repostCount, viewCount: $viewCount, shareCount: $shareCount, saveCount: $saveCount, reactionCounts: $reactionCounts, userReaction: $userReaction, gymTagName: $gymTagName, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'author_data') AuthorData authorData, String body,@JsonKey(name: 'media_urls') List<String> mediaUrls, List<PostMedia> media,@JsonKey(name: 'post_type') String postType,@JsonKey(name: 'location_label') String? locationLabel,@JsonKey(name: 'workout_log_data') Map<String, dynamic>? workoutLogData, Poll? poll,@JsonKey(name: 'comment_count') int commentCount,@JsonKey(name: 'repost_count') int repostCount,@JsonKey(name: 'view_count') int viewCount,@JsonKey(name: 'share_count') int shareCount,@JsonKey(name: 'save_count') int saveCount,@JsonKey(name: 'reaction_counts') Map<String, int> reactionCounts,@JsonKey(name: 'user_reaction') String? userReaction,@JsonKey(name: 'gym_tag_name') String? gymTagName,@JsonKey(name: 'created_at') String createdAt
});
...
/// Create a copy of OriginalPostData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? authorData = null,Object? body = null,Object? mediaUrls = null,Object? media = null,Object? postType = null,Object? locationLabel = freezed,Object? workoutLogData = freezed,Object? poll = freezed,Object? commentCount = null,Object? repostCount = null,Object? viewCount = null,Object? shareCount = null,Object? saveCount = null,Object? reactionCounts = null,Object? userReaction = freezed,Object? gymTagName = freezed,Object? createdAt = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
as List<PostMedia>,postType: null == postType ? _self.postType : postType // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'author_data')  AuthorData authorData,  String body, @JsonKey(name: 'media_urls')  List<String> mediaUrls,  List<PostMedia> media, @JsonKey(name: 'post_type')  String postType, @JsonKey(name: 'location_label')  String? locationLabel, @JsonKey(name: 'workout_log_data')  Map<String, dynamic>? workoutLogData,  Poll? poll, @JsonKey(name: 'comment_count')  int commentCount, @JsonKey(name: 'repost_count')  int repostCount, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'share_count')  int shareCount, @JsonKey(name: 'save_count')  int saveCount, @JsonKey(name: 'reaction_counts')  Map<String, int> reactionCounts, @JsonKey(name: 'user_reaction')  String? userReaction, @JsonKey(name: 'gym_tag_name')  String? gymTagName, @JsonKey(name: 'created_at')  String createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OriginalPostData() when $default != null:
return $default(_that.id,_that.authorData,_that.body,_that.mediaUrls,_that.media,_that.postType,_that.locationLabel,_that.workoutLogData,_that.poll,_that.commentCount,_that.repostCount,_that.viewCount,_that.shareCount,_that.saveCount,_that.reactionCounts,_that.userReaction,_that.gymTagName,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'author_data')  AuthorData authorData,  String body, @JsonKey(name: 'media_urls')  List<String> mediaUrls,  List<PostMedia> media, @JsonKey(name: 'post_type')  String postType, @JsonKey(name: 'location_label')  String? locationLabel, @JsonKey(name: 'workout_log_data')  Map<String, dynamic>? workoutLogData,  Poll? poll, @JsonKey(name: 'comment_count')  int commentCount, @JsonKey(name: 'repost_count')  int repostCount, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'share_count')  int shareCount, @JsonKey(name: 'save_count')  int saveCount, @JsonKey(name: 'reaction_counts')  Map<String, int> reactionCounts, @JsonKey(name: 'user_reaction')  String? userReaction, @JsonKey(name: 'gym_tag_name')  String? gymTagName, @JsonKey(name: 'created_at')  String createdAt)  $default,) {final _that = this;
switch (_that) {
case _OriginalPostData():
return $default(_that.id,_that.authorData,_that.body,_that.mediaUrls,_that.media,_that.postType,_that.locationLabel,_that.workoutLogData,_that.poll,_that.commentCount,_that.repostCount,_that.viewCount,_that.shareCount,_that.saveCount,_that.reactionCounts,_that.userReaction,_that.gymTagName,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
class _OriginalPostData implements OriginalPostData {
  const _OriginalPostData({required this.id, @JsonKey(name: 'author_data') required this.authorData, required this.body, @JsonKey(name: 'media_urls') final  List<String> mediaUrls = const <String>[], final  List<PostMedia> media = const <PostMedia>[], @JsonKey(name: 'post_type') this.postType = 'text', @JsonKey(name: 'location_label') this.locationLabel, @JsonKey(name: 'workout_log_data') final  Map<String, dynamic>? workoutLogData, this.poll, @JsonKey(name: 'comment_count') this.commentCount = 0, @JsonKey(name: 'repost_count') this.repostCount = 0, @JsonKey(name: 'view_count') this.viewCount = 0, @JsonKey(name: 'share_count') this.shareCount = 0, @JsonKey(name: 'save_count') this.saveCount = 0, @JsonKey(name: 'reaction_counts') final  Map<String, int> reactionCounts = const <String, int>{}, @JsonKey(name: 'user_reaction') this.userReaction, @JsonKey(name: 'gym_tag_name') this.gymTagName, @JsonKey(name: 'created_at') required this.createdAt}): _mediaUrls = mediaUrls,_media = media,_workoutLogData = workoutLogData,_reactionCounts = reactionCounts;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OriginalPostData&&(identical(other.id, id) || other.id == id)&&(identical(other.authorData, authorData) || other.authorData == authorData)&&(identical(other.body, body) || other.body == body)&&const DeepCollectionEquality().equals(other._mediaUrls, _mediaUrls)&&const DeepCollectionEquality().equals(other._media, _media)&&(identical(other.postType, postType) || other.postType == postType)&&(identical(other.locationLabel, locationLabel) || other.locationLabel == locationLabel)&&const DeepCollectionEquality().equals(other._workoutLogData, _workoutLogData)&&(identical(other.poll, poll) || other.poll == poll)&&(identical(other.commentCount, commentCount) || other.commentCount == commentCount)&&(identical(other.repostCount, repostCount) || other.repostCount == repostCount)&&(identical(other.viewCount, viewCount) || other.viewCount == viewCount)&&(identical(other.shareCount, shareCount) || other.shareCount == shareCount)&&(identical(other.saveCount, saveCount) || other.saveCount == saveCount)&&const DeepCollectionEquality().equals(other._reactionCounts, _reactionCounts)&&(identical(other.userReaction, userReaction) || other.userReaction == userReaction)&&(identical(other.gymTagName, gymTagName) || other.gymTagName == gymTagName)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,authorData,body,const DeepCollectionEquality().hash(_mediaUrls),const DeepCollectionEquality().hash(_media),postType,locationLabel,const DeepCollectionEquality().hash(_workoutLogData),poll,commentCount,repostCount,viewCount,shareCount,saveCount,const DeepCollectionEquality().hash(_reactionCounts),userReaction,gymTagName,createdAt);
...
/// Create a copy of OriginalPostData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? authorData = null,Object? body = null,Object? mediaUrls = null,Object? media = null,Object? postType = null,Object? locationLabel = freezed,Object? workoutLogData = freezed,Object? poll = freezed,Object? commentCount = null,Object? repostCount = null,Object? viewCount = null,Object? shareCount = null,Object? saveCount = null,Object? reactionCounts = null,Object? userReaction = freezed,Object? gymTagName = freezed,Object? createdAt = null,}) {
...
as List<String>,media: null == media ? _self.media : media // ignore: cast_nullable_to_non_nullable
as List<PostMedia>,commentsDisabled: null == commentsDisabled ? _self.commentsDisabled : commentsDisabled // ignore: cast_nullable_to_non_nullable
...
as String,reposters: null == reposters ? _self.reposters : reposters // ignore: cast_nullable_to_non_nullable
as List<ReposterData>,isSaved: null == isSaved ? _self.isSaved : isSaved // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(readValue: _readCommentsDisabled) final  bool commentsDisabled;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Post&&(identical(other.id, id) || other.id == id)&&(identical(other.authorData, authorData) || other.authorData == authorData)&&(identical(other.postType, postType) || other.postType == postType)&&(identical(other.body, body) || other.body == body)&&(identical(other.isAnonymous, isAnonymous) || other.isAnonymous == isAnonymous)&&const DeepCollectionEquality().equals(other._mediaUrls, _mediaUrls)&&const DeepCollectionEquality().equals(other._media, _media)&&(identical(other.commentsDisabled, commentsDisabled) || other.commentsDisabled == commentsDisabled)&&const DeepCollectionEquality().equals(other._tags, _tags)&&const DeepCollectionEquality().equals(other._workoutLogData, _workoutLogData)&&(identical(other.locationLabel, locationLabel) || other.locationLabel == locationLabel)&&(identical(other.viewCount, viewCount) || other.viewCount == viewCount)&&const DeepCollectionEquality().equals(other._reactionCounts, _reactionCounts)&&(identical(other.userReaction, userReaction) || other.userReaction == userReaction)&&(identical(other.commentCount, commentCount) || other.commentCount == commentCount)&&(identical(other.repostCount, repostCount) || other.repostCount == repostCount)&&(identical(other.saveCount, saveCount) || other.saveCount == saveCount)&&(identical(other.shareCount, shareCount) || other.shareCount == shareCount)&&(identical(other.isRepost, isRepost) || other.isRepost == isRepost)&&(identical(other.isRepostedByMe, isRepostedByMe) || other.isRepostedByMe == isRepostedByMe)&&(identical(other.originalPostId, originalPostId) || other.originalPostId == originalPostId)&&(identical(other.quoteBody, quoteBody) || other.quoteBody == quoteBody)&&const DeepCollectionEquality().equals(other._reposters, _reposters)&&(identical(other.isSaved, isSaved) || other.isSaved == isSaved)&&(identical(other.isPinned, isPinned) || other.isPinned == isPinned)&&(identical(other.visibility, visibility) || other.visibility == visibility)&&(identical(other.contentRating, contentRating) || other.contentRating == contentRating)&&(identical(other.moderationStatus, moderationStatus) || other.moderationStatus == moderationStatus)&&const DeepCollectionEquality().equals(other._aiAnalysis, _aiAnalysis)&&(identical(other.gymTagId, gymTagId) || other.gymTagId == gymTagId)&&(identical(other.gymTagName, gymTagName) || other.gymTagName == gymTagName)&&(identical(other.poll, poll) || other.poll == poll)&&(identical(other.originalPostData, originalPostData) || other.originalPostData == originalPostData)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,authorData,postType,body,isAnonymous,const DeepCollectionEquality().hash(_mediaUrls),const DeepCollectionEquality().hash(_media),commentsDisabled,const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_workoutLogData),locationLabel,viewCount,const DeepCollectionEquality().hash(_reactionCounts),userReaction,commentCount,repostCount,saveCount,shareCount,isRepost,isRepostedByMe,originalPostId,quoteBody,const DeepCollectionEquality().hash(_reposters),isSaved,isPinned,visibility,contentRating,moderationStatus,const DeepCollectionEquality().hash(_aiAnalysis),gymTagId,gymTagName,poll,originalPostData,createdAt,updatedAt]);
...
as bool,originalPostId: freezed == originalPostId ? _self.originalPostId : originalPostId // ignore: cast_nullable_to_non_nullable
as String?,quoteBody: null == quoteBody ? _self.quoteBody : quoteBody // ignore: cast_nullable_to_non_nullable
as String,reposters: null == reposters ? _self._reposters : reposters // ignore: cast_nullable_to_non_nullable
as List<ReposterData>,isSaved: null == isSaved ? _self.isSaved : isSaved // ignore: cast_nullable_to_non_nullable
as bool,isPinned: null == isPinned ? _self.isPinned : isPinned // ignore: cast_nullable_to_non_nullable
as bool,visibility: null == visibility ? _self.visibility : visibility // ignore: cast_nullable_to_non_nullable
as String,contentRating: null == contentRating ? _self.contentRating : contentRating // ignore: cast_nullable_to_non_nullable
